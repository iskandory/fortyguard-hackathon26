...
Full strategy, competitive landscape, judging criteria, and rationale: [HACKATHON_BRIEF.md](HACKATHON_BRIEF.md). FortyGuard API details: [API_REFERENCE.md](API_REFERENCE.md) — note its stated historical floor of 2019-01-01 is wrong, three independent sources say 2021-01-01, use 2021.
